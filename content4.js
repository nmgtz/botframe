...
function speakText(text) {
    if (isSpeaking) {
        ...
        var maleVoice = voices.find(voice => voice.name.includes('Male') || voice.name.includes('male') || voice.gender === 'male');

       
        if (!maleVoice) {
            maleVoice = voices.find(voice => voice.name.includes('Male') || voice.name.includes('male') || voice.gender === 'male');
        }
