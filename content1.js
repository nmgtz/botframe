...
var physWordList = [
                ...
                var othersWordList = [
                    'typewriter', 'typewritter', 'shorthand',"book", "chair", "table", "lamp", "pen", "notebook", "cup", "plate", "spoon", "fork", "knife", "phone", "computer", "keyboard", "mouse", "television", "remote", "window", "door", "bed", "pillow", "blanket", "towel", "soap", "shampoo", "toothbrush", "toothpaste", "mirror", "clock", "calendar", "bag", "shoes", "jacket", "hat", "glasses", "wallet", "keys", "bicycle", "car",
                ];
                var streetWordList = [
...
var statementGreetings = [
    'good morning', 'good afternoon', 'good evening', 'how are you', 'nice to meet you', 'pleased to meet you', 
    'it\'s nice to meet you', 'it\'s a pleasure to meet you', 'nice meeting you', 'pleasure meeting you', 
    'good to see you', 'it\'s good to see you', 'nice to see you', 'pleased to see you', 'it\'s nice to see you', 
    'it\'s a pleasure to see you', 'how\'s it going', 'how do you do'
];

const thankingStatements = [
    'thank you', 'thanks', 'thanks a lot', 'thank you very much', 'thanks so much', 'thanks for your help', 'thank you for your assistance'
];
